...
namespace Connect.DNN.Modules.FlickrGallery
{
    ...
    /// 
    /// Because the control inherits from FlickrGallerySettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : FlickrGalleryModuleSettingsBase
    {
