...
namespace Connect.DNN.Modules.FlickrGallery.Common
{
    public class ModuleBase : RazorModuleBase
    {
        ...
        {
            ClientResourceManager.RegisterScript(Page, ResolveUrl("~/DesktopModules/Connect/FlickrGallery/js/" + jsFilename), priority);
        }

        public void AddCssFile(string cssFileName)
        {
            ClientResourceManager.RegisterStyleSheet(Page, ResolveUrl("~/DesktopModules/Connect/FlickrGallery/css/" + cssFileName));
        }
        #endregion
